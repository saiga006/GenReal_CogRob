...
class MinimalKitchenSceneCfg(InteractiveSceneCfg):
    ...
    insulated_shelf = ArticulationCfg(
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            pos=(2.5, 0.5, 0.5),  # FIXED: Z=0.5 to properly sit above ground
    ...
    microwave = ArticulationCfg(
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            ...
            pos=(2.3, 0.5, 0.5 + MICROWAVE_HEIGHT_OFFSET),  # tuned via MICROWAVE_HEIGHT_OFFSET
    ...
    fridge = ArticulationCfg(
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            pos=(1.5, 0.75, 0.9),  # Moved closer to insulated_shelf (Y reduced from -1.5 to -0.6)
    ...
    CONTAINER_CFG = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(1.6534, 0.85, 1.4814),  # Updated to user-specified coordinates
            rot=(1.0, 0.0, 0.0, 0.0),
        ),
    )
