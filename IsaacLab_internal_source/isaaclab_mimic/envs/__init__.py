...
from .franka_kitchen_lift_visuomotor_mimic_env import FrankaKitchenLiftVisuomotorMimicEnv
from .franka_kitchen_lift_visuomotor_mimic_env_cfg import FrankaKitchenLiftVisuomotorMimicEnvCfg

# Import modules for gym registration
from . import franka_stack_ik_rel_mimic_env_cfg
from . import franka_stack_ik_rel_blueprint_mimic_env_cfg
from . import franka_stack_ik_abs_mimic_env_cfg
from . import franka_stack_ik_rel_visuomotor_mimic_env_cfg
from . import franka_kitchen_lift_visuomotor_mimic_env_cfg
...
##
# Kitchen Task - IK Relative Control
##

gym.register(
    id="Isaac-Kitchen-Lift-Franka-IK-Rel-Visuomotor-Mimic-v0",
    entry_point="isaaclab_mimic.envs:FrankaKitchenLiftVisuomotorMimicEnv",
    kwargs={
        "env_cfg_entry_point": franka_kitchen_lift_visuomotor_mimic_env_cfg.FrankaKitchenLiftVisuomotorMimicEnvCfg,
    },
    disable_env_checker=True,
)
