...
KINOVA_GEN3_N7_HIGH_PD_CFG = ArticulationCfg(
    ...
    actuators={
        "arm": ImplicitActuatorCfg(
            ...
            stiffness={
                "joint_[1-4]": 2000.0,  # Increased from 40.0
                "joint_[5-7]": 2000.0,  # Increased from 15.0
            },
            damping={
                "joint_[1-4]": 1600.0,  # Increased from 1.0
                "joint_[5-7]": 1600.0,  # Increased from 0.5
            },
        ),
    },
)
"""Configuration of Kinova Gen3 (7-Dof) arm with high PD gains.
