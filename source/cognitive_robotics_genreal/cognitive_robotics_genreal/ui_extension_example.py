...
def some_public_function(x: int):
    print("[cognitive_robotics_genreal] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[cognitive_robotics_genreal] startup")
    ...
    def on_shutdown(self):
        print("[cognitive_robotics_genreal] shutdown")